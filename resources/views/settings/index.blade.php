              ...
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="telepon" class="form-control" value="{{ $user->telepon }}" placeholder="+62 812-XXXX-XXXX">
                  </div>
                </div>
                <div class="col-md-6">
  ...
  <div class="tab-pane fade" id="tabBusiness">
    <div class="card">
      <div class="card-body">
        ...
        <form action="{{ route('settings.toko') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="mb-3">
            ...
            <div class="d-flex align-items-center gap-3">
              <div class="position-relative">
                <img id="previewLogo"
                  src="{{ $toko->logo ? asset('uploads/toko/'.$toko->logo) : 'https://ui-avatars.com/api/?name=M&background=f97316&color=fff&size=80' }}"
