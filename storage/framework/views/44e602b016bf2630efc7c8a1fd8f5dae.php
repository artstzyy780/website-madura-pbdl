<?php $__env->startSection('title','Control Access'); ?>
  ...
  <div class="card-body p-0">
    <table class="table table-hover mb-0">
      ...
      <tbody>
        ...
        <tr>
          <td class="fw-semibold font-monospace"><?php echo e($u->id_staff); ?></td>
          <td><?php echo e($u->name); ?></td>
          <td>
            <span class="badge-<?php echo e($u->status === 'on_air' ? 'on-air' : 'libur'); ?>">
              <?php echo e($u->status === 'on_air' ? 'On Air' : 'Libur'); ?>
          ...
          <td>
            <button class="btn btn-sm btn-outline-primary py-0 me-1" onclick='editUser(<?php echo e(json_encode($u)); ?>)'><i class="bi bi-pencil"></i></button>
            <?php if($u->id !== auth()->id()): ?>
            <button class="btn btn-sm btn-outline-danger py-0" onclick="hapusUser(<?php echo e($u->id); ?>, '<?php echo e($u->name); ?>')"><i class="bi bi-trash"></i></button>
            <?php endif; ?>
          </td>
        </tr>
...
<form id="formDelete" method="POST" style="display:none;"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?></form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MyBook Hype AMD\OneDrive\Dokumen\kuliah\smt4\database lanjutan\toko madura\toko-madura\resources\views/control-access/index.blade.php ENDPATH**/ ?>