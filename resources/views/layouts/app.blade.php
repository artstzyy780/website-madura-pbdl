...
<div class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    @if(auth()->user()->role === 'admin')
      <a href="{{ route('produk.kategori') }}"    class="{{ request()->routeIs('produk.*') ? 'active':'' }}"><i class="bi bi-box-seam"></i> Data Produk</a>
      <a href="{{ route('catatan.index') }}"      class="{{ request()->routeIs('catatan.*') ? 'active':'' }}"><i class="bi bi-journal-text"></i> Catatan Penjualan</a>
      <a href="{{ route('access.index') }}"       class="{{ request()->routeIs('access.*') ? 'active':'' }}"><i class="bi bi-shield-lock"></i> Control Access</a>
    @endif
    <a href="{{ route('laporan.index') }}"      class="{{ request()->routeIs('laporan.*') ? 'active':'' }}"><i class="bi bi-book"></i> Laporan Hutang</a>
    @if(auth()->user()->role === 'admin')
      <a href="{{ route('settings.index') }}"     class="{{ request()->routeIs('settings.*') ? 'active':'' }}"><i class="bi bi-gear"></i> Settings</a>
    @endif
  </nav>
</div>
